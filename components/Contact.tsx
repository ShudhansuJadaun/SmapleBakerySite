  ...
  return (
    <section id='contact' className=' w-full flex flex-col justify-start items-end gap-20 bg-cover h-fit lg:py-20 py-10 lg:px-20 px-10 bg-center' style={{ backgroundImage: `url('banner.jpg')` }}>
      ...
      <div className='lg:w-[60%] w-full flex flex-col justify-start items-center gap-10'>
        ...
        <p data-aos="zoom-in" data-aos-delay="400" className='text-center text-xl text-black'>Lorem ipsum dolor sit amet consectetur <br />adipisicing elit. Illum, velit.</p>
        <div className=' flex flex-col justify-center items-center gap-6 lg:w-[80%] w-full'>
          <div id='form-box' className='grid lg:grid-cols-2 grid-cols-1 justify-center items-center gap-4 w-full'>
            ...
            <div className=' w-full flex flex-col justify-center items-start gap-2'>
              ...
              <input type="email" placeholder='Enter your Email' className=' bg-white text-black px-6 py-3 w-full rounded-full border-2 border-slate-400' />
            </div>
          </div>
          <button className=' w-full bg-black px-6 py-3 rounded-full text-white font-semibold'>SUBMIT</button>
        </div>

        <div data-aos="zoom-in" data-aos-delay="600" id='address-box ' className=' w-full grid lg:grid-cols-3 grid-cols-1 justify-end gap-6 mt-10' >
          <div className=' flex flex-col justify-center items-start gap-3'>
            <h1 className=' text-black font-bold text-2xl'>FIND US</h1>
            <p className=' text-xl'>199 Boss Street, 58 <br /> Avenve, California, CF, 851-50045</p>
          </div>
          <div className=' flex flex-col justify-center items-start gap-3'>
            <h1 className=' text-black font-bold text-2xl'>FIND US</h1>
            <p className=' text-xl'>199 Boss Street, 58 <br /> Avenve, California, CF, 851-50045</p>
          ...
          <div className=' flex flex-col justify-center items-start gap-3'>
            ...
            <p className=' text-xl'>Ph-no = 9027560485 <br /> Ph-no2 = 8006891951</p>
          </div>
        </div>
      </div>
    </section>
