  ...
  return (
    <section id='about' className=' w-full flex lg:flex-row flex-col justify-between items-center'>
      <div id='content-section' className=' lg:w-[50%] w-full flex flex-col justify-center items-center gap-10 p-20'>
        <h1 data-aos="zoom-in" className='text-[50px] text-black text-center leading-[55px]'>Where Every Treat <br /> Tells a Tale</h1>
        <p data-aos="zoom-in" data-aos-delay="200" className=' text-center text-xl text-slate-600'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Natus qui dolor quod magni fugit aut illo exercitationem placeat quis aliquam.</p>
